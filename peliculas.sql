...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-06-2021 a las 19:31:04
...
INSERT INTO `peliculas` (`codigo_pelicula`, `nombre`, `director`, `genero`, `imagen`, `trailer`) VALUES
...
(29, 'juego de tronos', 'benioff', 'scienfi', 'Los pajaros.jpg', ''),
(32, 'Guillermo', 'dave Filony', 'ciencia ficcion', 'El_golpe.jpg', ''),
(33, 'PIN PIN', 'Myke Towers', 'Trap', 'Los pajaros.jpg', 'https://www.youtube.com/watch?v=5hllqh9AN1U');
...
--
ALTER TABLE `peliculas`
  MODIFY `codigo_pelicula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
COMMIT;
